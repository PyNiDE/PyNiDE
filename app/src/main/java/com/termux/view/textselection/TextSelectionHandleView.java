...
public class TextSelectionHandleView extends View {
    ...
    public TextSelectionHandleView(TerminalView terminalView, CursorController cursorController, int initialOrientation) {
        ...
        mHandleLeftDrawable = AppCompatResources.getDrawable(getContext(), R.drawable.ic_text_select_handle_left);
        mHandleRightDrawable = AppCompatResources.getDrawable(getContext(), R.drawable.ic_text_select_handle_right);
