...
private final int LIST_SELECTOR_COLOR = 0xff000000;
    ...
    public FloatingToolbar(Context context, View windowView) {
    ...
    private final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View parent) {
            ...
            mMarginHorizontal = SizeUtils.dp2px(16);
            mMarginVertical = SizeUtils.dp2px(8);
            mLineHeight = SizeUtils.dp2px(48);
            mIconTextSpacing = SizeUtils.dp2px(8);
            ...
            mOverflowButtonIcon = new AppCompatImageButton(mContext) {
                @Override
            ...
            mOverflowButtonIcon.setLayoutParams(new ViewGroup.LayoutParams(SizeUtils.dp2px(56), SizeUtils.dp2px(48)));
            mOverflowButtonIcon.setPaddingRelative(SizeUtils.dp2px(16), SizeUtils.dp2px(12), SizeUtils.dp2px(16), SizeUtils.dp2px(12));
            ...
            mOverflowButtonText.setText(context.getString(R.string.back));
            ...
            int color = MaterialColors.getColor(parent, R.attr.textColorOnSurface);
            mOverflowButtonIcon.setBackground(Theme.createSelectorDrawable(LIST_SELECTOR_COLOR, Theme.RIPPLE_MASK_CIRCLE_20DP));
            mOverflowButton.setBackground(Theme.createSelectorDrawable(LIST_SELECTOR_COLOR, Theme.RIPPLE_MASK_ALL));
            mOverflowButtonShadow.setBackgroundColor(com.google.android.material.R.color.material_divider_color);
            ...
            mOverflowButton.addView(mOverflowButtonShadow, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, 1f / context.getResources().getDisplayMetrics().density, Gravity.TOP | Gravity.FILL_HORIZONTAL));
        ...
        private void setPanelsStatesAtRestingPosition() {
            ...
            if (mIsOverflowOpen) {
                ...
                mOverflowButton.setContentDescription(mContentContainer.getContext().getString(R.string.more_options));
        ...
        private int getAdjustedToolbarWidth(int suggestedWidth) {
            ...
            refreshViewPort();
            int maximumWidth = mViewPortOnScreen.width() - 2 * SizeUtils.dp2px(16);
            if (width <= 0) {
                width = SizeUtils.dp2px(400);
            }
            ...
            OverflowPanel(FloatingToolbarPopup popup) {
                ...
                setOutlineProvider(new ViewOutlineProvider() {
                    ...
                    public void getOutline(View view, Outline outline) {
                        outline.setRoundRect(0, 0, view.getMeasuredWidth(), view.getMeasuredHeight() + SizeUtils.dp2px(6), SizeUtils.dp2px(6));
                    }
                });
        ...
        private final class OverflowPanelViewHelper {
            ...
            public OverflowPanelViewHelper(Context context, int iconTextSpacing) {
                ...
                mSidePadding = SizeUtils.dp2px(18);
    ...
    private View createMenuItemButton(Context context, MenuItem menuItem, int iconTextSpacing, boolean first, boolean last) {
        ...
        menuItemButton.setMinimumWidth(SizeUtils.dp2px(48));
        menuItemButton.setMinimumHeight(SizeUtils.dp2px(48));
        menuItemButton.setPaddingRelative(SizeUtils.dp2px(16), 0, SizeUtils.dp2px(16), 0);
        ...
        int color;
        int selectorColor = LIST_SELECTOR_COLOR;
        textView.setTextColor(color = MaterialColors.getColor(textView, com.google.android.material.R.attr.colorOnSurface));

        if (first || last) {
            menuItemButton.setBackground(Theme.createRadSelectorDrawable(selectorColor, first ? 6 : 0, last ? 6 : 0, last ? 6 : 0, first ? 6 : 0));
        } else {
            menuItemButton.setBackground(Theme.getSelectorDrawable(selectorColor));
        }

        textView.setPaddingRelative(SizeUtils.dp2px(11), 0, 0, 0);
        menuItemButton.addView(textView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, SizeUtils.dp2px(48)));
    ...
    private ViewGroup createContentContainer(Context context) {
        ...
        layoutParams.bottomMargin = layoutParams.leftMargin = layoutParams.topMargin = layoutParams.rightMargin = SizeUtils.dp2px(20);
        contentContainer.setLayoutParams(layoutParams);
        contentContainer.setElevation(SizeUtils.dp2px(2));
        contentContainer.setFocusable(true);
        contentContainer.setFocusableInTouchMode(true);
        GradientDrawable shape = new GradientDrawable();
        shape.setShape(GradientDrawable.RECTANGLE);
        int r = SizeUtils.dp2px(6);
        shape.setCornerRadii(new float[]{r, r, r, r, r, r, r, r});
        shape.setColor(MaterialColors.getColor(contentContainer, com.google.android.material.R.attr.colorSurfaceContainer));
