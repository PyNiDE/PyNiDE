...
public class IntegerSimpleMenuPreference extends Preference {
    ...
    public IntegerSimpleMenuPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, rikka.preference.simplemenu.R.styleable.ListPreference, defStyleAttr, defStyleRes);
        mEntries = TypedArrayUtils.getTextArray(typedArray, rikka.preference.simplemenu.R.styleable.ListPreference_entries, rikka.preference.simplemenu.R.styleable.ListPreference_android_entries);
        mEntryValues = getIntArray(typedArray, rikka.preference.simplemenu.R.styleable.ListPreference_entryValues, rikka.preference.simplemenu.R.styleable.ListPreference_android_entryValues);
        typedArray.recycle();

        /* Retrieve the Preference summary attribute since it's private
         * in the Preference class.
         */
        typedArray = context.obtainStyledAttributes(attrs, rikka.preference.simplemenu.R.styleable.Preference, defStyleAttr, defStyleRes);
        mSummary = TypedArrayUtils.getString(typedArray, rikka.preference.simplemenu.R.styleable.Preference_summary, rikka.preference.simplemenu.R.styleable.Preference_android_summary);
        typedArray.recycle();

        typedArray = context.obtainStyledAttributes(attrs, rikka.preference.simplemenu.R.styleable.SimpleMenuPreference, defStyleAttr, defStyleRes);
        int popupStyle = typedArray.getResourceId(rikka.preference.simplemenu.R.styleable.SimpleMenuPreference_android_popupMenuStyle, rikka.preference.simplemenu.R.style.Widget_Preference_SimpleMenuPreference_PopupMenu);
        int popupTheme = typedArray.getResourceId(rikka.preference.simplemenu.R.styleable.SimpleMenuPreference_android_popupTheme, rikka.preference.simplemenu.R.style.ThemeOverlay_Preference_SimpleMenuPreference_PopupMenu);
    ...
    public void onBindViewHolder(@NonNull PreferenceViewHolder holder) {
        ...
        if (mAnchor == null) {
            throw new IllegalStateException("SimpleMenuPreference item layout must contain" + "a view id is android.R.id.empty to support iconSpaceReserved");
        }
    }
}
