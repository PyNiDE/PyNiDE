...
public class IntegerSimpleMenuPreference extends Preference {
    ...
    public IntegerSimpleMenuPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ListPreference, defStyleAttr, defStyleRes);
        ...
        mEntryValues = getIntArray(typedArray, R.styleable.ListPreference_entryValues, R.styleable.ListPreference_android_entryValues);
        typedArray.recycle();

        /* Retrieve the Preference summary attribute since it's private
         * in the Preference class.
         */
        typedArray = context.obtainStyledAttributes(attrs, R.styleable.Preference, defStyleAttr, defStyleRes);
        mSummary = TypedArrayUtils.getString(typedArray, R.styleable.Preference_summary, R.styleable.Preference_android_summary);
        typedArray.recycle();

        typedArray = context.obtainStyledAttributes(attrs, R.styleable.SimpleMenuPreference, defStyleAttr, defStyleRes);
        int popupStyle = typedArray.getResourceId(R.styleable.SimpleMenuPreference_android_popupMenuStyle, R.style.Widget_Preference_SimpleMenuPreference_PopupMenu);
        int popupTheme = typedArray.getResourceId(R.styleable.SimpleMenuPreference_android_popupTheme, R.style.ThemeOverlay_Preference_SimpleMenuPreference_PopupMenu);
