...
public final class FloatingActionMode extends ActionMode {
    ...
    public FloatingActionMode(
        ...
        MenuUtils.setDefaultShowAsAction(mMenu, MenuItem.SHOW_AS_ACTION_IF_ROOM);
        setType(ActionMode.TYPE_FLOATING);
        popupMenu.setOnMenuItemClickListener(menuItem -> mCallback.onActionItemClicked(FloatingActionMode.this, menuItem));
        ...
        mBottomAllowance = context.getResources()
                .getDimensionPixelSize(R.dimen.floating_toolbar_content_rect_bottom_clip_allowance);
    ...
    private void setFloatingToolbar(FloatingToolbar floatingToolbar) {
        mFloatingToolbar = floatingToolbar
                .setMenu(mMenu)
                .setOnMenuItemClickListener(item -> mCallback.onActionItemClicked(FloatingActionMode.this, item));
    ...
    private void repositionToolbar() {
        ...
        if (parent instanceof ViewGroup) {
            ViewUtils.getChildVisibleRect(parent, mOriginatingView, mContentRectOnScreen, null, true);
