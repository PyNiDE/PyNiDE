...
import com.android.floatingtoolbar.FloatingActionMode;
import com.android.floatingtoolbar.FloatingToolbar;
...
public class TerminalView extends View {
    ...
    private View mAttachedToWindow;

    public TerminalView(@NonNull Context context) {
        this(context, null);
    }

    public TerminalView(@NonNull Context context, AttributeSet attributes) { // NO_UCD (unused code)
        ...
        defaultBackgroundColor = MaterialColors.getColor(this, android.R.attr.colorBackground);
    }
    ...
    private void cleanupFloatingActionModeViews() {
        ...
        if (mFloatingToolbarPreDrawListener != null) {
            getViewTreeObserver().removeOnPreDrawListener(mFloatingToolbarPreDrawListener);
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        if (mWindowView != null || mAttachedToWindow != null) {
            if (mFloatingActionMode != null) {
                mFloatingActionMode.finish();
            }
            cleanupFloatingActionModeViews();
            mFloatingToolbar = new FloatingToolbar(getContext(), mWindowView != null ? mWindowView : mAttachedToWindow);
            mFloatingActionMode = new FloatingActionMode(getContext(), new ActionModeCallback2Wrapper(callback), this, mFloatingToolbar);
            mFloatingToolbarPreDrawListener = () -> {
                if (mFloatingActionMode != null) {
                    mFloatingActionMode.updateViewLocationInWindow();
                }
                return true;
            };
            callback.onCreateActionMode(mFloatingActionMode, mFloatingActionMode.getMenu());
            extendActionMode(mFloatingActionMode, mFloatingActionMode.getMenu());
            mFloatingActionMode.invalidate();
            getViewTreeObserver().addOnPreDrawListener(mFloatingToolbarPreDrawListener);
            invalidate();
            return mFloatingActionMode;
        } else {
