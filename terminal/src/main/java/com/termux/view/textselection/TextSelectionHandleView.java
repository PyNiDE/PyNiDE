...
public class TextSelectionHandleView extends View {
    ...
    public TextSelectionHandleView(TerminalView terminalView, CursorController cursorController, int initialOrientation) {
        ...
        mHandleLeftDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_text_select_handle_left);
        mHandleRightDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_text_select_handle_right);
    ...
    private void initHandle() {
        ...
        mHandle.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        mHandle.setAnimationStyle(0);
        mHandle.setEnterTransition(null);
        mHandle.setExitTransition(null);
        PopupWindowCompat.setWindowLayoutType(mHandle, WindowManager.LayoutParams.TYPE_APPLICATION_SUB_PANEL);
